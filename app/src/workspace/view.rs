...
use crate::server::telemetry::{
    ...
    OpenedWarpAISource, SharingDialogSource, TierLimitHitEvent,
    WarpDriveSource,
};
...
impl Workspace {
    ...
    fn open_settings_pane(
        ...
        let panes_layout = PanesLayout::Snapshot(Box::new(PaneNodeSnapshot::Leaf(LeafSnapshot {
            ...
            contents: LeafContents::Settings(SettingsPaneSnapshot::Local {
                current_page: page.unwrap_or(SettingsSection::WarpAgent),
    ...
    fn user_menu_items(&self, _app: &AppContext) -> Vec<MenuItem<WorkspaceAction>> {
        ...
        // Slim fork: no Sign up / Upgrade / Billing / Invite / Log out — every one
        // of those routes through a Warp account.
        items
    }
...
impl TypedActionView for Workspace {
    ...
    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        ...
        match action {
            ...
            Reauth => {
                // Slim fork: there is no Warp reauth flow.
